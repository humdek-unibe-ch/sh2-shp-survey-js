# SurveyJS Plugin User Documentation

Audience: Non-technical survey authors, CMS admins, and operators.
Status: active.
Applies to: `sh2-shp-survey-js`.
Last verified: 2026-06-03.
Source of truth: Observable behavior of the current plugin build (admin Survey Creator, runtime style, and mobile renderer).
